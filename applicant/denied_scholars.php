                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>Denied Lists
                            </li>
                        </ol>
                        <?php
                         /*   $servername = "localhost";
                            ...
                            $sql = "SELECT * FROM APPLICANT WHERE DENIED = 'TRUE'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo    '<details>'.
                                            '<summary>'. '<div class= studentborder>'."Student Id: " . $row["STUDENT_ID"]. " - " . $row["FIRST_NAME"]. " " . $row["LAST_NAME"]." " . $row["MIDDLE_NAME"]. '</div>'.'</summary>'.
                                            "<br>".
