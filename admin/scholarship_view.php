                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-mortar-board"></i> Scholarships
                            </li>
                        </ol>
                    </div>
                </div>
                               ...
                               <div class="panel-heading" style='border-bottom: 2px solid rgb(255, 153, 51);'>
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <i class="fa fa-calendar fa-graduation-cap fa-3x"></i>
                                        <div><i><strong><h4>Ateneo De Naga University</h4></strong></i></div>
                                        <div><i><strong><h4>Scholarship Program</h4></strong></i></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                <td><?php echo $row['GENERAL_TYPE']?></td>
                                                <td><?php echo $row['SPECIFIC_TYPE']?></td>
                                                <td><?php echo $row['MAINTAINING_QPI']?></td>
                                                <td><a href="scholarship_edit.php?id=<?php echo $row['SCHOLARSHIP_ID']; ?> " class="btn btn-success" role="button" > Edit </a></td>
                                            </tr>
                                                <?php 
                                                }
