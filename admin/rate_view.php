            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-money"></i>  <a href="index.php">Rate</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-"></i> Rate View
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="panel-heading" style='border-bottom: 2px solid rgb(255, 153, 51);'>
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div><i><strong><h4>Rate</h4></strong></i></div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-hover">
                                        ...
                                        <thead>
                                            <tr>    
                                                ...
                                                <th><center>Deficiency Amount</center></th>                                                
                                            </tr>
                                        </thead>
                                    <tbody>
                                                <?php
                                                ...
                                                ?>
                                                <tr>
                                                <td><center><?php echo $row['SYEAR']?></center></td>
                                                <td><center><?php echo $row['DEFICIENCY_AMOUNT']?></center></td>
                                                <td><a href="rate_edit.php?id=<?php echo $row['RATE_ID']; ?> " class="btn btn-success" role="button" > Edit </a></td>
                                            </tr>
                                                <?php 
                                                }
