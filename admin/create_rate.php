                    ...
                    <!-- Form row/column-->
                                        <div class="row register-form">
                                            ...
                                            <div class="col-md-8 col-md-offset-2">
                                                ...
                                                <form class="form-horizontal custom-form" action="create_rate.php" method="post">
                                                      <hr>
                                                    <h1 class="text-justify">Create Rate</h1><img src="../images/hat.png" width="100">
                                                    ...
                                                    <button class="btn btn-default submit-button" type="submit" name="create_rate">Create Rate</button>
