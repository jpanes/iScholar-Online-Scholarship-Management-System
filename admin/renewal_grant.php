 ...
 ?>
    ...
    <div id="wrapper" style="background-color:#edf2f4;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                  <i class="fa fa-exchange"></i> Renewwd Scholars
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <?php
         ...
         $query ="SELECT * FROM renewal WHERE GRANTEE_STATUS = 'RENEWED' AND school_year = '$sy' AND SEMESTER = '$sem'";
                              ...
                              <div class="panel-heading" style='border-bottom: 2px solid rgb(255, 153, 51);'>
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h5>List of Renewed Scholarship</h5>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                                ...
                                                <td><a href="renewal_view_approved.php?id=<?php echo $row['RENEWAL_ID']; ?> " class="btn btn-success" role="button" > View </a></td>
