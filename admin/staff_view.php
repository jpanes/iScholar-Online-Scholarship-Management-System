                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-users"></i> Admission Staff
                            </li>
                        </ol>
                    </div>
                </div>
...
---------------------------------------------->
        ...
        <?php
         ...
         $query ="SELECT * FROM admission_staff";
                             ...
                             <div class="panel-heading" style='border-bottom: 2px solid rgb(255, 153, 51);'>
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div><i><strong><h4>Admission Staff</h4></strong></i></div>
                                    </div>
                                     <a href="create_staff.php" class="btn btn-info btn-warning"  style="margin-left: 10px;"><i class="fa fa-fw fa-plus"></i> Add Staff</a><br>
                                </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                                ...
                                                <td><a href="staff_edit.php?id=<?php echo $row['STAFF_ID']; ?> " class="btn btn-success" role="button" > Edit </a></td> 
                                            </tr>
                                                <?php 
                                                }
