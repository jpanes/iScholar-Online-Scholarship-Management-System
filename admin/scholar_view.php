...
$this->Cell(0  ,5,'List of ADNU Scholars',0,1,'C');//end of line
...
$query ="SELECT * FROM scholar WHERE SYEAR_GRANTED = '".$_SESSION['SY']."' AND SEMESTER_GRANTED = '".$_SESSION['SEM']."'";
$result = mysqli_query($connect, $query);

while($data=mysqli_fetch_array($result)){

$pdf->Cell(30,5,$data['ID_NUMBER'],1,0,'L');
$pdf->Cell(45,5,$data['FIRST_NAME']." ".$data['MIDDLE_NAME'].". ".$data['LAST_NAME'],1,0,'L');
$pdf->Cell(65,5,$data['COURSE'],1,0,'L');
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <br>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-mortar-board"></i> Users
                            </li> 
                            <li class="active">
                        ...
                        <div class ="input-group">
                            ...
                            <input type="text" name="search" id="search" placeholder="Search scholar" class="form-control" style="width: 250px;" />
                             <form method="post">
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger btn-md" type="submit" name="print_scholar">
                                ...
                                <form method="post" action="excel_export.php">
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-success btn-md" type="submit" name="excel_scholar">
                                            <i class="fa fa-file-excel-o fa-1.9x">
                                            </i> Excel 
                                        </button>
                                        <a href="create_scholar.php" class="btn btn-info btn-warning"><i class="fa fa-fw fa-plus"></i> Add Scholar</a>
                                    </div>
                                </form>
                        </div>
                            <br>  
...
---------------------------------------------->
   <?php
    $sy = $_SESSION['SY'];
    $sem =$_SESSION['SEM'];
         $query ="SELECT * FROM scholar sa, scholarship sc where sa.scholarship_id = sc.scholarship_id and SYEAR_GRANTED = '$sy' AND SEMESTER_GRANTED = '$sem'" ;
         $result = mysqli_query($connect, $query);
         ?>
              ...
              <div class="row">
                     <div class="col-lg-12">
                        <div class="panel panel-primary" style="border: 0; ">
                            <div class="panel-heading" style='border-bottom: 2px solid rgb(255, 153, 51);'>
                                <div class="row">
                                    <div class="text-center">
                                        ...
                                        <div><i><strong><h4>Scholars</h4></strong></i></div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover " id="scholar_table">
                                    ...
                                    <tbody>
                                                ...
                                                <td><?php echo $row['SPECIFIC_TYPE']?></td>
                                                 <td><a href="scholar_edit.php?id=<?php echo $row['SCHOLAR_ID']; ?> " class="btn btn-success" role="button" > Edit </a></td>
...
<!-- jquery Code for searching scholar -->
    ...
    <script>  
      $(document).ready(function(){  
           ...
           function search_table(value){  
                $('#scholar_table tr').each(function(){  
                     var found = 'false';  
                     $(this).each(function(){  
